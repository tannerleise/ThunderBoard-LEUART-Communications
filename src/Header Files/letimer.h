...
typedef struct {
  ...
  bool      comp0_irq_enable;   //Enables interrupt on comp0 interrupt
  uint32_t  comp0_cb;
  bool      comp1_irq_enable;   //Enables interrupt on comp1 interrupt
  uint32_t  comp1_cb;
  bool      uf_irq_enable;      //Enables interrupt on uf interrupt
  uint32_t  uf_cb;
